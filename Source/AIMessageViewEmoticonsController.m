...
#pragma mark AIMessageViewEmoticonsControlle

@interface AIMessageViewEmoticonsController ()

- (id)initWithNibName:(NSString *)nibName textView:(AIMessageEntryTextView *)textView;
/*
...
{
	[[[self alloc] initWithNibName:@"MessageViewEmoticonsMenu" textView:textView] autorelease];
}

/*!
 * @brief Set-up and open the menu
 */
- (id)initWithNibName:(NSString *)nibName textView:(AIMessageEntryTextView *)aView
{
