...
- (void)windowDidLoad
{
	...
	[checkBox_logWriting setStringValue:AILocalizedString(@"Log to ~/Library/Logs/Adium Debug", "Logging checkbox in the Adium Debug Window")];
	[button_clear setStringValue:AILocalizedString(@"Clear", nil)];
