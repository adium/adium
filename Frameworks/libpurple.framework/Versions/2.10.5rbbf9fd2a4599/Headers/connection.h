...
typedef enum
{
	...
	/** We tried to restore the connection, but it did not happen in time.
	 */
	PURPLE_CONNECTION_ERROR_RESUMPTION_FAILED = 16,
...
typedef enum
{
	PURPLE_CONNECTION_ERROR_IGNORE = -1,
	PURPLE_CONNECTION_ERROR_DISCONNECT = 0
} PurpleConnectionErrorResponse;
