...
/** Set the role of participants in a MUC.
 *  @param conv         the room in which to set the role
 *  @param participants a NULL terminated list of nicks in the room
 *  @param role         the role to set (moderator, none, participant or visitor)
 */
gboolean jabber_muc_set_role(PurpleConversation *conv, char **participants, char *role);

/** Set the affiliation of participants in a MUC.
 *  @param conv         the room in which to set the affiliation
 *  @param participants a NULL terminated list of nicks or JIDs in the room
 *  @param affiliation  the affiliation to set (owner, admin, member, outcast or none)
 */
gboolean jabber_muc_set_affiliation(PurpleConversation *conv, char **participants, char *affiliation);

/** Request configuration form for a MUC from the server.
 *  @param conv         the room to configure
 */
